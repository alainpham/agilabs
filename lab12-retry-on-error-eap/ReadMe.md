Red Hat Fuse on EAP Spring XML Web Application : lab12-retry-on-error-eap
==============================================
...
http://localhost:8080/lab12-retry-on-error-eap/webjars/swagger-ui/2.1.0/index.html?url=/lab12-retry-on-error-eap/camel/api-docs

For testing

    curl http://localhost:8080/lab12-retry-on-error-eap/camel/api-docs
    curl http://localhost:8080/lab12-retry-on-error-eap/camel/ping
