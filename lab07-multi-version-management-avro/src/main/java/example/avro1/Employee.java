...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4221676102155381012L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"example.avro1\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"emails\",\"type\":{\"type\":\"array\",\"items\":\"string\"}}]}");
   ...
   */
  public Employee(java.lang.CharSequence name, java.lang.Integer age, java.util.List<java.lang.CharSequence> emails) {
    this.name = name;
    this.age = age;
    this.emails = emails;
  }
   ...
   */
  public static example.avro1.Employee.Builder newBuilder() {
    return new example.avro1.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static example.avro1.Employee.Builder newBuilder(example.avro1.Employee.Builder other) {
    return new example.avro1.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static example.avro1.Employee.Builder newBuilder(example.avro1.Employee other) {
    return new example.avro1.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(example.avro1.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(example.avro1.Employee other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro1.Employee.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro1.Employee.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro1.Employee.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro1.Employee.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro1.Employee.Builder setEmails(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro1.Employee.Builder clearEmails() {
      emails = null;
